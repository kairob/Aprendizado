...
type homeScreenProp = NativeStackNavigationProp<RootStackParamsList, 'Cars'>;
///////////////////////////////////////////////////////////////////////////////////////////
...
export default function Cars() {
  ...
  return (
    <SafeAreaView style={StylePage.ContainerCars}>
      ...
      <View style={StylePage.ContainerBodyCars} />
      <View style={StylePage.ContainerFooterCars} />
    </SafeAreaView>
  );
}
